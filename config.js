...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("254793651678,")
...
global.gurl = 'https://instagram.com/p1princeone' // add your username
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '℘ཞıŋƈɛ◎ŋɛ' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Princeone' : process.env.OWNER_NAME,
  ownernumber: process.env.OWNER_NUMBER === undefined ? '254793651678' : process.env.OWNER_NUMBER,
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? '℘ཞıŋƈɛ◎ŋɛ' : process.env.PACK_INFO.split(";")[1],	
